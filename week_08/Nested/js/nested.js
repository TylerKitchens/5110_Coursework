 ...
 * extra examples
 */
//document.querySelector("#asteroid").innerHTML = asteroid.orbital_data.perihelion_argument
//document.querySelector("#asteroid").innerHTML = asteroid.close_approach_data[0].orbiting_body

document.querySelector("#challenge1").innerHTML =  "The asteroid named " + asteroid.name + " is between " + asteroid.estimated_diameter.miles.estimated_diameter_min + " and " + asteroid.estimated_diameter.miles.estimated_diameter_max + " miles wide, and will miss Earth by approximately " + asteroid.close_approach_data[0].miss_distance.miles + " miles"
document.querySelector("#challenge2").href = asteroid.links.self
